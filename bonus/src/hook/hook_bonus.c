...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/14 15:33:24 by yzhan             #+#    #+#             */
/*   Updated: 2025/02/14 15:33:28 by yzhan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "miniRT_bonus.h"

static void	key_action(int keycode, t_key *keys)
{
	if (keycode == TAB || keycode == P)
		keys->action = SELECT;
