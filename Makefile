...
BONUS_SRCS =	main_bonus.c \
				...
				illumination_bonus.c intersection_bonus.c ray_bonus.c reflection_bonus.c render_bonus.c refraction_bonus.c \
				...
				debug_shape_bonus.c \
				uv_bonus.c \
				color_bonus.c color_utils_bonus.c texture_bonus.c bump_bonus.c
